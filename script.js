const formInput = document.querySelector('.subscribe-form input');
const formSubmit = document.querySelector('.subscribe-form button');
...
formSubmit.addEventListener('click', e => {
  ...
  if(formInput.value === "" || !formInput.value.match(emailRegex)) {
